...
namespace ApiServer.Infrastructure.Migrations
{
    ...
    [Migration("20241127145917_AddUserUniqueConstraint")]
            ...
            modelBuilder.Entity("ApiServer.Domain.Entities.ApiSetting", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "SET_LIMIT_DAY",
                            CreatedAt = new DateTime(2024, 11, 27, 14, 59, 17, 349, DateTimeKind.Local).AddTicks(9302),
                            Description = "The maximum number of sets that can be created per day by a user. Zero for unlimited",
                            Type = "Integer",
                            UpdatedAt = new DateTime(2024, 11, 27, 14, 59, 17, 349, DateTimeKind.Local).AddTicks(9351),
                            Value = "20"
                        });
                });
            ...
            modelBuilder.Entity("ApiServer.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "1mvcs1kEiT1X/+4KvAEpI0Yea0JCa7x+2hpZGihm/pK7qrBWbtzBJwN7NSRcrecKKDN/5kuSQzPQZ76CjT95cg==",
                            PasswordSalt = "AHdtwHiJ78BgfgyL87+6nn+BXrCxa4H8vgcARPFooovHfHed1gYy+tiyG3h1+AB7K5434O707q9vPP02UgVZ2g==",
                            Username = "student"
                        },
                        new
                        {
                            ...
                            PasswordHash = "3jtSiy1yZMxVe0b9LhexIV5FHL+/im0Py7DCTfGAqQSMRN91aLqQ9Xa+DLagHImiTwu2+aaWEwz80SAoPlclIQ==",
                            PasswordSalt = "hG+4wXFAbdNVYgaffYJPRqzK70s4mhWJAn3nn9Bfn7TEp4VKxItVYlWXPgeIDNBLxTTyKZUimXMjbj4LNrFKNg==",
                            Username = "admin"
                        });
                });
